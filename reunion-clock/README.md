...
`gulp publish` will upload your [`dist/`](dist/) folder to the `embeds/2018/reunion-clock/` folder on our interactives S3 bucket.
...
```html
<div id="embed-reunion-clock"></div>

<script src="//pym.nprapps.org/pym.v1.min.js"></script>
<script>new pym.Parent('embed-reunion-clock', '//interactives.dallasnews.com/embeds/2018/reunion-clock/', {})</script>
```
